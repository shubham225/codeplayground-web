...
export default function Home() {
  return (
    <div>
      <div className="px-4 pt-10 h-full md:pt-20 ">
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          >
            ...
            <Card className="absolute hidden 2xl:inline-flex -top-6 p-3 items-center">
              <JavaOriginal size={30} strokeWidth={2} />
            </Card>

            <Card className="absolute hidden 2xl:inline-flex top-52 -left-20 p-3 items-center">
              <JavascriptOriginal size={30} strokeWidth={2} />
            </Card>

            <Card className="absolute hidden 2xl:inline-flex -bottom-6 p-3 items-center">
              <CplusplusOriginal size={30} strokeWidth={2} />
            </Card>
            {/* Right side language logos  */}

            <Card className="absolute hidden 2xl:inline-flex -top-6 right-0 p-3 items-center">
              <COriginal size={30} strokeWidth={2} />
            </Card>

            <Card className="absolute hidden 2xl:inline-flex top-52 -right-20 p-3 items-center">
